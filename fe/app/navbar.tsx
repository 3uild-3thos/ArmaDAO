...
export const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/30">
      <div className="bg-amber-50 text-muted-foreground font-medium p-2 text-sm text-center md:flex w-full justify-center items-center">
      ...
      <div className="bg-gradient-blue uppercase text-muted font-bold p-2 text-sm text-center md:flex w-full justify-center items-center">
        Watch the{" "}
        <Link
          href={
