...
const CompletedNumber = ({ className }: ICompletedNumber) => {
  return (
    <div className={cn("relative z-10 justify-center flex", className)}>
      <div className="absolute h-full w-[4px] bg-gradient-to-b from-cyan/15 to-transparent top-4 mx-auto z-[-1] left-0 right-0" />
      <div
        className={
          "h-10 w-10 p-2 flex justify-center items-center rounded-full bg-cyan/15 z-10 mt-[-8px]"
        }
      >
        <div
          className={
        ...
        >
          <div
            className={
              "h-4 w-4 p-2 flex justify-center items-center rounded-full bg-cyan z-30"
            }
          >
