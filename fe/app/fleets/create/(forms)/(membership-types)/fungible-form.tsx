...
interface IFungibleForm {
  form: UseFormReturn<IFleetConfig>;
}

const FungibleForm = ({ form }: IFungibleForm) => {
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="space-y-3">
            <p>Do you have an existing mint address for the token?</p>
            <FormControl>
              <RadioGroup
              ...
              >
                ...
                <FormItem className="flex items-center space-x-3 space-y-0">
                  ...
                  <p>No, I don&apos;t have it and let&apos;s create one.</p>
                </FormItem>
              </RadioGroup>
            </FormControl>
            <FormMessage />
                ...
                <FormControl>
                  <div className="grid grid-cols-5 gap-4">
                    ...
                    <div className="col-span-3 space-y-2">
                      <Input
                        type="number"
                        {...form.register("config.minStakedRequiredProposal")}
                        {...field}
